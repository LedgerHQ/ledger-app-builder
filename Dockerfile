...
RUN curl -sSfL -o arm-toolchain.tar.bz2 "https://armkeil.blob.core.windows.net/developer/Files/downloads/gnu-rm/10.3-2021.07/gcc-arm-none-eabi-10.3-2021.07-x86_64-linux.tar.bz2" && \
    echo b56ae639d9183c340f065ae114a30202 arm-toolchain.tar.bz2 > /tmp/arm-toolchain.md5 && \
